//Use the Document Object Model (DOM) to complete the following exercises below:/*Use the Document Object Model (DOM) to complete the following exercises below:*/

/*1. Taylor Swift

Find the element with the id of "name1":
	- Replace the content with the following string "Tay-Tay"*/
document.getElementById("name1").innerHTML = "Tay-Tays"
/*2. DJ Khaled
...
*/
document.getElementsByClassName("profile")[1].innerHTML = "Mistakes are always forgivable, if one has the courage to admit them."
